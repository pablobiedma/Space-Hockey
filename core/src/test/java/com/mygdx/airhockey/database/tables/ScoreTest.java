...
class ScoreTest {
    ...
    transient Score score = new Score(username, points, chosenName);
    transient Score scoreSet = new Score(username, points, chosenName);
    ...
    @Test
    void testToString() {
        String string = "Score{, Username='aap', Score='1', Chosen name='noot'}";
        Assertions.assertEquals(string, score.toString());
    }

    @Test
    void testHashCode() {
        Score x = new Score(username,points, chosenName);
        Score y = new Score(username, points,chosenName);
    ...
    @Test
    void testEquals() {
        Score scoreSame = new Score(username, points, chosenName);
        Score scoreWrong = new Score(wrong,0, wrong);
